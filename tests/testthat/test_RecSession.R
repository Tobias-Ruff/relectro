...
test_that("RecSession",{
  ...
  rs<-setRecSession(rs,
                ...
                stimulation=c("train_fake","none","train_10"),
                setup=c("A","A","A"),
